            ...
            for (let notification of notifications) {
                ...
                if (notification.comment_notification !== null) {
                    if (notification.comment_notification.adv_id !== null) {
                        ...
                        notification.url = `${applicationURL}/noticias/${notification.comment_notification.adv_id}/${notification.comment_notification.adv_name}`;
                    }
                ...
                if (notification.reply_notification !== null) {
                    if (notification.reply_notification.comment_id !== null) {
                        ...
                        if (notification.reply_notification.comment.adv_id !== null) {
                            notification.url = `${applicationURL}/noticias/${notification.reply_notification.comment.adv_id}/${notification.reply_notification.comment.adv_name}`;
                        }
                        if (notification.reply_notification.comment.chp_id !== null) {
                            notification.url = `${applicationURL}/novelas/${notification.reply_notification.comment.nvl_id}/${notification.reply_notification.comment.nvl_name}/${notification.reply_notification.comment.chp_id}/${notification.reply_notification.comment.chp_name}`;
                        }
                    }
